 ...
 *      $Revision: 1.15 $       $Date: 2011/02/26 03:27:31 $
 *
 ***************************************************************************/
...
#define HOOMD_UNKNOWN  19       /**< unknown tag          */
#define HOOMD_NUMTAGS  20       /**< number of known tags */

/* This list has to stay consistend with the defines above */
static const char *hoomd_tag_name[HOOMD_NUMTAGS] = {
  "(none)", "hoomd_xml", "configuration", "box", /*  4 */
  "position", "image", "velocity",               /*  7 */
  "type", "body", "mass", "charge", "diameter",  /* 11 */
  "bond", "angle", "dihedral", "improper",       /* 15 */
  "wall", "coord", "acceleration", "(error)"     /* 19 */
};
